...
voltages up to $V_\text{in}$. The inputs to the LM393 essentially consist of
...
Assuming active operation, a cursory analysis models the path from $V_\text{in}$
...
$I_\text{in,(+)}$ is set by the much larger (about 300 times or so) current set
